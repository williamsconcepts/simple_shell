 ...
 * @s: the string whose length to checks
 *
...
/**
 * starts_with - checks if needle starts with haystacks
 * @haystack: string to searches
 * @needle: the substring to finds
 *
 ...
 *
 * Returns: pointer to destination buffers
 */
